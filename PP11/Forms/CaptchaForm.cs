...
namespace PP11
{
    public partial class CaptchaForm : PatternForm
    {
        private string text;
        ...
        private void buttonCheck_Click(object sender, EventArgs e)
        {
            ...
            {
                ((AuthorizationForm)Owner).captchaPassed = true;
                this.Close();
            }
            else
            {
                ((AuthorizationForm)Owner).captchaPassed = false;
                this.Close();
            }
        }
